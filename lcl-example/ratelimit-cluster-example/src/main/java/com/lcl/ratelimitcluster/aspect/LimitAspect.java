package com.lcl.ratelimitcluster.aspect;
...
public class LimitAspect {
    ...
    @Around("execution(* com.lcl.ratelimitcluster.controller ..*(..) )")
    public Object interceptor(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (rateLimit != null) {
            ...
            Number number = redisTemplate.execute(defaultRedisScript, keys, rateLimit.count(), rateLimit.time());
